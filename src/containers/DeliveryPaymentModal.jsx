...
const DeliveryPaymentModal = () => (
  <Dialog title="Доставка и оплата">
    <div id="delivery-text-wrap">
      ...
      <span>Дата бронирования после внесения предоплаты 50% от заказа , остаток в день доставки</span>
      <span>Работаем с юр.лицами, предоставляем все необходимые документы для оплаты по реквизитам</span>
      ...
      <span>При заказе на сумму от 10.000₽ доставка бесплатная в неотдаленные районы ( список районов уточняйте)</span>
    </div>
  </Dialog>
);
